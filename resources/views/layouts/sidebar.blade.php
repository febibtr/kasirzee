        ...
        <ul class="metismenu" id="menu">
            ...
            <li class="mega-menu mega-menu-sm">
                ...
                <ul aria-expanded="false">
                    <li><a href="./layout-blank.html">Barang Atau Jasa</a></li>
                    <li><a href="./layout-one-column.html">Manajemen Stok</a></li>
                    <li><a href="{{ route('kategori.index') }}">Kategori</a></li>
                    <li><a href="./layout-compact-nav.html">Supplier</a></li>
            ...
            <li class="mega-menu mega-menu-sm">
                ...
                <ul aria-expanded="false">
                    ...
                    <li><a href="./email-read.html">Pembelian</a></li>
                </ul>
            </li>
            <li class="mega-menu mega-menu-sm">
                <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="./email-inbox.html">Akun</a></li>
                    <li><a href="./email-inbox.html">Logout</a></li>
                </ul>
            </li>
    </div>
</div>